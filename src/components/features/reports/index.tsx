						...
						<div className='flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between'>
							<div>
								...
								<p className='mt-2 max-w-3xl text-sm text-zinc-500 sm:text-base'>
									Halaman ini menggabungkan kebutuhan onboarding untuk unduh
									desktop agent dan kebutuhan reporting untuk unduh report per
									habit.
								</p>
							</div>
									...
									<div className='flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between'>
										<div>
											...
											<p className='mt-2 max-w-2xl text-base text-zinc-500 sm:text-lg'>
												Sesuai PRD, user perlu mengunduh tracker yang terhubung
												akun serta mengekspor report kebiasaan untuk evaluasi
												progress harian dan streak.
											</p>
										</div>
										...
										<div className='flex flex-wrap gap-3'>
											...
											<Button
												variant='outline'
												className='h-11 rounded-2xl border-lime-300 bg-lime-500 px-5 text-white shadow-[0_14px_30px_rgba(132,204,22,0.28)] hover:border-lime-400 hover:bg-lime-400 hover:text-white'>
										...
										<div
											...
											<div className='flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between'>
												<div className='flex gap-4'>
													<IconTile
														icon={item.icon}
														className={cn("border-none", item.accentClassName)}
													/>
													<div>
												...
												<Button
													variant='outline'
													className='h-10 rounded-2xl border-lime-300 bg-lime-500 px-4 text-white shadow-[0_14px_30px_rgba(132,204,22,0.28)] hover:border-lime-400 hover:bg-lime-400 hover:text-white'>
													<Download className='size-4' />
													Download
												</Button>
											</div>
												...
												<div className='flex flex-wrap gap-2'>
													{report.exportFormats.map((format) => (
														<Button
															key={format}
															variant='outline'
															className='h-10 rounded-2xl border-sky-300 bg-sky-500 px-4 text-white shadow-[0_14px_30px_rgba(14,165,233,0.24)] hover:border-sky-400 hover:bg-sky-400 hover:text-white'>
															<FileSpreadsheet className='size-4' />
															{format}
														</Button>
													))}
								...
								<SectionCard
									...
									<div className='rounded-[22px] border border-zinc-200 bg-zinc-50 p-4'>
										...
										<p className='mt-2 text-sm text-zinc-600'>
											Download tracker saat onboarding, lalu export per-habit
											report mingguan untuk melihat progress penggunaan,
											distraction time, dan streak compliance.
										</p>
									</div>
								</SectionCard>
							</motion.div>
